...
import org.cliente.jpa.models.Curso;
import org.cliente.jpa.models.Instructor;
import java.util.List;

public class Main {
    public static void main(String[] args) {
        Client cliente = ClientBuilder.newClient();
        WebTarget rootUri = cliente.target("http://127.0.0.1:8081/webapp-jawrs-jpa/api").path("/cursos");
