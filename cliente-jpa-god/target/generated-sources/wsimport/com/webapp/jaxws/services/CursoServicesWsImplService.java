 ...
 * 
 */
@WebServiceClient(name = "CursoServicesWsImplService", targetNamespace = "http://services.jaxws.webapp.com/", wsdlLocation = "http://localhost:8080/web-app-jaxws-jpa/CursoServicesWsImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CURSOSERVICESWSIMPLSERVICE_QNAME = new QName("http://services.jaxws.webapp.com/", "CursoServicesWsImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/web-app-jaxws-jpa/CursoServicesWsImpl?wsdl");
    ...
    public CursoServicesWs getCursoServicesWsImplPort() {
        return super.getPort(new QName("http://services.jaxws.webapp.com/", "CursoServicesWsImplPort"), CursoServicesWs.class);
    }
    ...
    public CursoServicesWs getCursoServicesWsImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.jaxws.webapp.com/", "CursoServicesWsImplPort"), CursoServicesWs.class, features);
    }
