 ...
 * generated in the com.webapp.jaxws.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _Crear_QNAME = new QName("http://services.jaxws.webapp.com/", "crear");
    private final static QName _CrearResponse_QNAME = new QName("http://services.jaxws.webapp.com/", "crearResponse");
    private final static QName _Listar_QNAME = new QName("http://services.jaxws.webapp.com/", "listar");
    private final static QName _ListarResponse_QNAME = new QName("http://services.jaxws.webapp.com/", "listarResponse");
    private final static QName _Saludar_QNAME = new QName("http://services.jaxws.webapp.com/", "saludar");
    private final static QName _SaludarResponse_QNAME = new QName("http://services.jaxws.webapp.com/", "saludarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.webapp.jaxws.services
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.com/", name = "crear")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.com/", name = "crearResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.com/", name = "listar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.com/", name = "listarResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.com/", name = "saludar")
     ...
     */
    @XmlElementDecl(namespace = "http://services.jaxws.webapp.com/", name = "saludarResponse")
