 ...
 * 
 */
@WebServiceClient(name = "ServicesWsImplService", targetNamespace = "http://services.jaxws.webapp.com/", wsdlLocation = "http://localhost:8081/web-app-jaxws/ServicesWsImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/web-app-jaxws/ServicesWsImpl?wsdl");
